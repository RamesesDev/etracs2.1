declare @lguname varchar(50)
declare @lguindexno varchar(50)

SELECT @lguname = 'LGUNAME-HERE', @lguindexno='LGU-INDEX-NO'


ALTER TABLE lguname_etracs..subdivisionland ADD administratorname VARCHAR(200);
ALTER TABLE lguname_etracs..subdivisionland ADD administratoraddress VARCHAR(200);
...
CREATE TABLE lguname_etracs..[personnel_txncode](
 ...
 CONSTRAINT [PK_personnel_txncode] PRIMARY KEY CLUSTERED 
(
	[personnelid] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY],
 CONSTRAINT [Unique_personnelid] UNIQUE NONCLUSTERED 
(
	[personnelid] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY],
 CONSTRAINT [Unique_txncode] UNIQUE NONCLUSTERED 
(
	[txncode] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
update lguname_etracs..landrysetting set appliedto = @lguname;
update lguname_etracs..bldgrysetting set appliedto = @lguname;
update lguname_etracs..machrysetting set appliedto = @lguname;
update lguname_etracs..planttreerysetting set appliedto = @lguname;
update lguname_etracs..miscrysetting set appliedto = @lguname;


insert into lguname_etracs..rysetting_lgu 
select objid, @lguindexno, @lguname, 'land' from lguname_etracs..landrysetting;

insert into lguname_etracs..rysetting_lgu 
select objid, @lguindexno, @lguname, 'bldg' from lguname_etracs..bldgrysetting;

insert into lguname_etracs..rysetting_lgu 
select objid, @lguindexno, @lguname, 'mach' from lguname_etracs..machrysetting;

insert into lguname_etracs..rysetting_lgu 
select objid, @lguindexno, @lguname, 'misc' from lguname_etracs..miscrysetting;

insert into lguname_etracs..rysetting_lgu 
select objid, @lguindexno, @lguname, 'planttree' from lguname_etracs..planttreerysetting;





ALTER TABLE lguname_etracs..rptledger ADD undercompromised int not null;
