...
<%@ attribute name="bottomactions" fragment="true" %>
...
<table width="100%">
	...
	<tr>
		<td align="left" class="content-title">
			${title}
			<c:if test="${!empty subtitle}">
				<br><i class="content-subtitle">${subtitle}</i>
			</c:if>
		</td>
		<td align="right">
...
<c:if test="${not empty bottomactions}">
	<div class="bottomactions">
		<jsp:invoke fragment="bottomactions"/>
	</div>
</c:if>
