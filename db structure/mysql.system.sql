...
insert  into `sys_cluster_host`(`name`,`context`,`host`) values ('server1','tagbilaran','10.0.0.151:8080');
...
insert  into `sys_roleclass_module`(`roleclass`,`module`) values ('BP','bp2'),('TREASURY','bp2'),('TREASURY','ctc2'),('ADMIN','etracs2-admin'),('BP','etracs2common'),('IT','etracs2common'),('RPT','etracs2common'),('TREASURY','etracs2common'),('ADMIN','jobposition'),('ADMIN','orgunit'),('ADMIN','personnel'),('ADMIN','role'),('RPT','rpt2'),('TREASURY','rpt2'),('ACCOUNTING','tc2'),('TREASURY','tc2');
...
insert  into `sys_sequence`(`objid`,`nextSeries`) values ('ENTITY',2);
...
insert  into `sys_session`(`sessionid`,`username`,`host`,`dtaccessed`) values ('server1:-5f57ff92:136af9059ab:-7ffe','taskscheduler','server1','2012-04-14 14:35:59'),('server1:-5f57ff92:136af9059ab:-7ffd','admin','server1','2012-04-14 14:37:36');
