...
-- CREATE DATABASE /*!32312 IF NOT EXISTS*/`bohol_system` /*!40100 DEFAULT CHARACTER SET latin1 */;
-- USE `bohol_system`;
...
insert  into `sys_cluster_host`(`name`,`context`,`host`) values ('server1','bohol','10.0.0.152:8080');
...
insert  into `sys_roleclass`(`name`,`description`,`rolelevel`,`tags`) values ('ACCOUNTING','ACCOUNTING',1,NULL),('ADMIN','ADMIN',1,NULL),('BP','BUSINESS LICENSING',1,NULL),('IT','IT',1,NULL),('RPT','RPT ASSESSMENT',1,'[\'ASSESSOR\', \'APPROVER\', \'TAXMAPPER\', \'APPRAISER\', \'RECOMMENDER\']'),('TREASURY','TREASURY',1,'[\'AFO\', \'CASHIER\', \'COLLECTOR\', \'LIQUIDATING_OFFICER\']');
...
insert  into `sys_sequence`(`objid`,`nextSeries`) values ('2010-01-0001',10),('BP2012',14),('CancelAnnotation',2),('DEPOSIT2012',3),('ENTITY',17),('FAASAnnotation',3),('IRAF-C2012',6),('LIQ-2012',3),('NOTICEOFASSESSMENT',4),('PERMIT2012',2),('REM-2012',7),('RIV-2012',9),('SUBDIVISION',3);
...
insert  into `sys_session`(`sessionid`,`username`,`host`,`dtaccessed`) values ('server1:11d79be1:136aeedd1d4:-7ffe','taskscheduler','server1','2012-04-14 11:38:29'),('server1:11d79be1:136aeedd1d4:-7ffd','admin','server1','2012-04-14 19:20:44');
