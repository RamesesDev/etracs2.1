...
MySQL - 5.0.27-community-nt : Database - tagbilaran_system
*********************************************************************
*/
...
-- CREATE DATABASE /*!32312 IF NOT EXISTS*/`tagbilaran_system` /*!40100 DEFAULT CHARACTER SET latin1 */;
-- USE `tagbilaran_system`;
...
CREATE TABLE `cms_link` (
  ...
  KEY `FK_cms_link` (`folderid`),
  CONSTRAINT `FK_cms_link` FOREIGN KEY (`folderid`) REFERENCES `cms_folder` (`objid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
insert  into `rule`(`objid`,`schemaname`,`schemaversion`,`docstate`,`rulename`,`description`,`packagename`,`author`,`salience`,`agendagroupid`,`agendagroup`,`ruleset`,`effectivefrom`,`effectiveto`,`ruletext`,`conditions`,`actions`,`extended`) values ('R-231e4220:136af009089:-7ff8','rule','1.0','DEPLOYED','SEF','SEF','rptbilling.SEF','NAZARENO, ELMO',50000,'TAX','TAX','rptbilling',NULL,NULL,'package rptbilling.SEF;\n\nimport etracs2.rpt.billing.facts.*\nimport java.util.*\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"SEF\"\nagenda-group \"TAX\"\nno-loop\nsalience 50000\n\nwhen\n$LEDGER : RPTLedgerFact( $ledgerid:ledgerid )\nCurrentYearFact(CY:year)\nRPTLedgerFact(AV:assessedvalue, classid matches \"COM|RES\", ledgerid == $ledgerid)\nthen\n$LEDGER.setSefacctid(\"IA41a0f494:13564c96212:-7f36\");\n$LEDGER.setExpr(\"AV * 0.01\");\n$LEDGER.setRevtype(\"current\");\n$LEDGER.setVarlist( new HashMap() );\nactionList.setContext( drools );\nactionList.execute(\"calcSef\", $LEDGER);\nend','[[objid:\"RC-3265c80f:136af013594:-7ffa\",opener:\"rpt-rule-mgmt:rptilling_condition_currentyearfact\",displaytext:\"CurrentYearFact(CY: year)\",constraints:[[displaytext:\"CY: year\",fieldvar:\"CY\",value:null,field:[valueHandler:\"integer\",datatype:\"integer\",operatorHandler:\"number\",caption:\"Year\",name:\"year\"],usevar:false]],factname:\"CurrentYearFact\",conditiontype:\"CurrentYearFact\"],[objid:\"RC-3265c80f:136af013594:-7ff9\",opener:\"rpt-rule-mgmt:rptilling_condition_ledgerfact\",displaytext:\"RPTLedgerFact(AV: assessedvalue, classid matches COMMERCIAL, RESIDENTIAL)\",constraints:[[displaytext:\"AV: assessedvalue\",fieldvar:\"AV\",value:null,field:[valueHandler:\"decimal\",datatype:\"decimal\",operatorHandler:\"number\",caption:\"Assessed Value\",name:\"assessedvalue\"],usevar:false],[displaytext:\"classid matches COMMERCIAL, RESIDENTIAL\",fieldvar:null,value:[[objid:\"COM\",name:\"COMMERCIAL\"],[objid:\"RES\",name:\"RESIDENTIAL\"]],field:[valueHandler:\"classification\",datatype:\"string\",operatorHandler:\"string\",caption:\"Classification\",name:\"classid\"],usevar:false,operator:[caption:\"matches\",name:\"matches\"]]],factname:\"RPTLedgerFact\",conditiontype:\"RPTLedgerFact\"]]','[[objid:\"RA-3265c80f:136af013594:-7ff8\",opener:\"rpt-rule-mgmt:rptbilling_action_sef\",displaytext:\"Calculate SEF using formula: AV * 0.01\",acctid:\"IA41a0f494:13564c96212:-7f36\",accttitle:\"SEF CURRENT\",expr:\"AV * 0.01\",actiontype:\"calcSef\"]]','[version:\"1.0\"]'),('R-231e4220:136af009089:-7ffb','rule','1.0','DEPLOYED','BASIC','BASIC COMPUTATION','rptbilling.BASIC','NAZARENO, ELMO',50000,'TAX','TAX','rptbilling',NULL,NULL,'package rptbilling.BASIC;\n\nimport etracs2.rpt.billing.facts.*\nimport java.util.*\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"BASIC\"\nagenda-group \"TAX\"\nno-loop\nsalience 50000\n\nwhen\n$LEDGER : RPTLedgerFact( $ledgerid:ledgerid )\nCurrentYearFact(CY:year)\nRPTLedgerFact(AV:assessedvalue, ledgerid == $ledgerid)\nthen\n$LEDGER.setBasicacctid(\"IA41a0f494:13564c96212:-7f22\");\n$LEDGER.setExpr(\"AV * 0.01\");\n$LEDGER.setRevtype(\"current\");\n$LEDGER.setVarlist( new HashMap() );\nactionList.setContext( drools );\nactionList.execute(\"calcBasic\", $LEDGER);\nend','[[objid:\"RC-3265c80f:136af013594:-7ffe\",opener:\"rpt-rule-mgmt:rptilling_condition_currentyearfact\",displaytext:\"CurrentYearFact(CY: year)\",constraints:[[displaytext:\"CY: year\",fieldvar:\"CY\",value:null,field:[valueHandler:\"integer\",datatype:\"integer\",operatorHandler:\"number\",caption:\"Year\",name:\"year\"],usevar:false]],factname:\"CurrentYearFact\",conditiontype:\"CurrentYearFact\"],[objid:\"RC-3265c80f:136af013594:-7ffc\",opener:\"rpt-rule-mgmt:rptilling_condition_ledgerfact\",displaytext:\"RPTLedgerFact(AV: assessedvalue)\",constraints:[[displaytext:\"AV: assessedvalue\",fieldvar:\"AV\",value:null,field:[valueHandler:\"decimal\",datatype:\"decimal\",operatorHandler:\"number\",caption:\"Assessed Value\",name:\"assessedvalue\"],usevar:false]],factname:\"RPTLedgerFact\",conditiontype:\"RPTLedgerFact\"]]','[[objid:\"RA-3265c80f:136af013594:-7ffb\",opener:\"rpt-rule-mgmt:rptbilling_action_basic\",displaytext:\"Calculate Basic Tax using formula: AV * 0.01\",acctid:\"IA41a0f494:13564c96212:-7f22\",accttitle:\"BASIC CURRENT\",expr:\"AV * 0.01\",actiontype:\"calcBasic\"]]','[version:\"1.0\"]'),('R-3d3b8925:1369bc575be:-7ffd','rule','1.0','DEPLOYED','ASK_GROSS','GROSS INFORMATION','bpassessment.ASK_GROSS','NAZARENO, ELMO',50000,'APPINFO','APPLICATION INFO','bpassessment',NULL,NULL,'package bpassessment.ASK_GROSS;\nimport bp.assessment.facts.*;\nimport java.util.*;\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"ASK_GROSS1\"\nagenda-group \"APPINFO\"\nno-loop\nsalience 50000\n\nwhen\n$app : ApplicationFact( $appid: appid )\n$lob : LOBFact( $lobid:lobid, $lobname:name, appid == $appid)	\nLOBFact( assessmenttype matches \"RENEW\", lobid == $lobid, appid == $appid )\n\nthen\nMap m = new HashMap();\nm.put(\"lobid\", $lobid );\nm.put(\"lobname\", $lobname );\nm.put(\"rulename\", \"ASK_GROSS\");\nm.put(\"varid\", \"V7bcf5fff:136857a553d:-7fee\" );\nm.put(\"requiredperlob\", true );\nm.put(\"required\", true );\nm.put(\"requiredbeforeprint\", false );\nactionList.setContext( drools );\nactionList.execute(\"addInfo\", m );\nend\n\n','[[objid:\"RC-511bfa01:1369bc4078c:-7ffd\",opener:\"bp-rule-mgmt:bpassessment_condition_lobapptype\",displaytext:\"Line of Business Assessment Type is any of the following:  RENEW\",types:[\"RENEW\"],conditiontype:\"lobapptype\"]]','[[objid:\"RA-511bfa01:1369bc4078c:-7ffb\",opener:\"bp-rule-mgmt:bpassessment_action_requireinfo\",displaytext:\"Ask information : GROSS per each Line of Business\",applyperlob:true,required:true,requiredbeforeprint:false,conditions:[],variable:[printtopermit:null,schemaname:\"variable\",description:null,datatype:\"decimal\",caption:\"GROSS SALES\",name:\"GROSS\",schemaversion:\"1.0\",objid:\"V7bcf5fff:136857a553d:-7fee\",arrayvalues:\"[]\"],actiontype:\"requireinfo\"]]','[version:\"1.0\"]'),('R-45ead6bd:136a8c63948:-7fe6','rule','1.0','DEPLOYED','DISCOUNT_TEST','DISCOUNT','bpbilling.DISCOUNT_TEST','NAZARENO, ELMO',50000,'DISCOUNT','DISCOUNT','bpbilling',NULL,NULL,'package bpbilling.DISCOUNT_TEST;\n\nimport bp.billing.facts.*\nimport java.util.*\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"DISCOUNT_TEST\"\nagenda-group \"DISCOUNT\"\nno-loop\nsalience 50000\n\nwhen\n$LEDGER : BPLedgerFact( $ledgerid:ledgerid )\n$TAXFEE : TaxFeeFact( $taxfeeid:taxfeeid, ledgerid == $ledgerid )\nTaxFeeFact(AMTDUE:amount, taxfeeid == $taxfeeid, ledgerid == $ledgerid)\nthen\n$TAXFEE.setDiscount(AMTDUE * 0.25);\nactionList.setContext( drools );\nactionList.execute(\"calcDiscount\", $TAXFEE );\nend','[[objid:\"RC101f2a92:136a9b5a3fc:-7ffe\",opener:\"bp-rule-mgmt:bpbilling_condition_taxfeefact\",displaytext:\"TaxFeeFact(AMTDUE: amount)\",constraints:[[displaytext:\"AMTDUE: amount\",fieldvar:\"AMTDUE\",value:null,field:[valueHandler:\"decimal\",datatype:\"decimal\",operatorHandler:\"number\",caption:\"Amt Due\",name:\"amount\"],usevar:false]],factname:\"TaxFeeFact\",conditiontype:\"TaxFeeFact\"]]','[[objid:\"RA101f2a92:136a9b5a3fc:-7ffd\",opener:\"bp-rule-mgmt:bpbilling_action_discount\",displaytext:\"Calculate Discount using formula: AMTDUE * 0.25\",expr:\"AMTDUE * 0.25\",actiontype:\"calcDiscount\"]]','[version:\"1.0\"]'),('R-45ead6bd:136a8c63948:-7ff0','rule','1.0','DEPLOYED','INTEREST','INTEREST','bpbilling.INTEREST','NAZARENO, ELMO',50000,'INTEREST','INTEREST','bpbilling',NULL,NULL,'package bpbilling.INTEREST;\n\nimport bp.billing.facts.*\nimport java.util.*\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"INTEREST\"\nagenda-group \"INTEREST\"\nno-loop\nsalience 50000\n\nwhen\n$LEDGER : BPLedgerFact( $ledgerid:ledgerid )\n$TAXFEE : TaxFeeFact( $taxfeeid:taxfeeid, ledgerid == $ledgerid )\nTaxFeeFact(applysurcharge == true, AMTDUE:amount, taxfeeid == $taxfeeid, ledgerid == $ledgerid)\nthen\n$TAXFEE.setInterestacctid(\"IA41a0f494:13564c96212:-7f28\");\n$TAXFEE.setInterestaccttitle(\"BASIC CURRENT PENALTY\");\n$TAXFEE.setInterest(AMTDUE * 0.25);\n\nactionList.setContext( drools );\nactionList.execute(\"calcInterest\", $TAXFEE );\nend','[[objid:\"RC3db34207:136a9a9c6e0:-7ffe\",opener:\"bp-rule-mgmt:bpbilling_condition_taxfeefact\",displaytext:\"TaxFeeFact(applysurcharge == true, AMTDUE: amount)\",constraints:[[displaytext:\"applysurcharge == true\",fieldvar:null,value:true,field:[valueHandler:\"boolean\",datatype:\"boolean\",operatorHandler:\"boolean\",caption:\"Apply Surcharge\",name:\"applysurcharge\"],usevar:false,operator:[caption:\"is\",name:\"==\"]],[displaytext:\"AMTDUE: amount\",fieldvar:\"AMTDUE\",value:null,field:[valueHandler:\"decimal\",datatype:\"decimal\",operatorHandler:\"number\",caption:\"Amt Due\",name:\"amount\"],usevar:false]],factname:\"TaxFeeFact\",conditiontype:\"TaxFeeFact\"]]','[[objid:\"RA3db34207:136a9a9c6e0:-7ffd\",opener:\"bp-rule-mgmt:bpbilling_action_interest\",displaytext:\"Calculate Interest using formula: AMTDUE * 0.25 for account BASIC CURRENT PENALTY\",acctid:\"IA41a0f494:13564c96212:-7f28\",accttitle:\"BASIC CURRENT PENALTY\",expr:\"AMTDUE * 0.25\",actiontype:\"calcInterest\"]]','[version:\"1.0\"]'),('R-48081d1f:136a0d7a169:-7fe5','rule','1.0','DEPLOYED','GF','GARBAGE FEE','bpassessment.GF','NAZARENO, ELMO',50000,'RF','REGULATORY FEE','bpassessment',NULL,NULL,'package bpassessment.GF;\nimport bp.assessment.facts.*;\nimport java.util.*;\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"GF1\"\nagenda-group \"RF\"\nno-loop\nsalience 50000\n\nwhen\n$app : ApplicationFact( $appid: appid )\n$lob : LOBFact( $lobid:lobid, $lobname:name, appid == $appid)	\nLOBFact( lobid not matches \"L22004bc9:13677342510:-7ff4\", lobid == $lobid, appid == $appid )\n\nthen\nMap m = new HashMap();\nm.put(\"rulename\", \"GF\");\nm.put(\"appid\", $appid);\nm.put(\"lobid\", $lobid);\nm.put(\"lobname\", $lobname);\nm.put(\"expr\", \"100\");\nm.put(\"acctid\", \"IA57e27d97:135e1abe297:-7fe6\");\nm.put(\"accttitle\", \"AFFIDAVITS (DEATH)\");\nm.put(\"applytype\", \"PERLINE\" );\nactionList.setContext( drools );\nactionList.execute(\"addTaxFee\", m );\nend\n\n','[[objid:\"RC-3733da9:136a102e07d:-7eaf\",opener:\"bp-rule-mgmt:bpassessment_condition_lob\",displaytext:\"Line of Business excludes the following: SARI SARI\",includetype:\"EXCLUDE\",lobs:[[objid:\"L22004bc9:13677342510:-7ff4\",name:\"SARI SARI\"]],conditiontype:\"lob\"]]','[[objid:\"RA-3733da9:136a102e07d:-7ffc\",opener:\"bp-rule-mgmt:bpassessment_action_taxfeecharge\",displaytext:\"Compute AFFIDAVITS (DEATH) using formula 100. Apply per Line of Business\",applytype:[name:\"PERLINE\",caption:\"Apply per Line of Business\"],computationmode:\"FORMULA\",expr:\"100\",acctid:\"IA57e27d97:135e1abe297:-7fe6\",accttitle:\"AFFIDAVITS (DEATH)\",actiontype:\"taxfeecharge\"]]','[version:\"1.0\"]'),('R2ac8d955:136af351c76:-7ff5','rule','1.0','DEPLOYED','UPDATE_AMOUNT_RULE','UPDATE AMOUNT GROSS','bpassessment.UPDATE_AMOUNT_RULE','NAZARENO, ELMO',50000,'ABT','AFTER BUSINESS TAX','bpassessment',NULL,NULL,'package bpassessment.UPDATE_AMOUNT_RULE;\nimport bp.assessment.facts.*;\nimport java.util.*;\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"UPDATE_AMOUNT_RULE1\"\nagenda-group \"ABT\"\nno-loop\nsalience 50000\n\nwhen\n$app : ApplicationFact( $appid: appid )\n$lob : LOBFact( $lobid:lobid, $lobname:name, appid == $appid)	\nTAXFEEFACT: TaxFeeFact( AMOUNTDUE:assessedvalue, $acctid:acctid matches \"IA68fbd6ca:135e5876658:-7e80\", appid == $appid, lobid == $lobid )\n\nthen\nMap m = new HashMap();\nm.put(\"rulename\", \"UPDATE_AMOUNT_RULE\");\nm.put(\"taxfeefact\", TAXFEEFACT );\nm.put(\"expr\", \"AMOUNTDUE * 0.50\");\nm.put(\"varname\", \"AMOUNTDUE\");\nm.put(\"varvalue\", AMOUNTDUE);\nactionList.setContext( drools );\nactionList.execute(\"updateAnyTaxFee\", m );\nend\n\n','[[objid:\"RC-2d9c8c7d:136af51fe6e:-7ffb\",opener:\"bp-rule-mgmt:bpassessment_condition_taxfee\",displaytext:\"Tax Fee Account is any of the following: BENEFIT DANCE\",accounts:[[amounttype:null,acctno:null,fundname:\"GENERAL\",fundid:\"GENERAL\",acctcode:null,accttitle:\"BENEFIT DANCE\",objid:\"IA68fbd6ca:135e5876658:-7e80\",defaultvalue:0.00]],option:[name:\"ANY\",caption:\"each line of business calculated\"],conditiontype:\"taxfee\"]]','[[objid:\"RA-2d9c8c7d:136af51fe6e:-7ffa\",opener:\"bp-rule-mgmt:bpassessment_action_updatetaxfee\",displaytext:\"Update amount due using the formula : AMOUNTDUE * 0.50\",conditions:[],expr:\"AMOUNTDUE * 0.50\",actiontype:\"updatetaxfee\"]]','[version:\"1.0\"]'),('R75dbe68b:136a4905785:-7ffd','rule','1.0','DEPLOYED','TEST','TEST','bpbilling.TEST','NAZARENO, ELMO',50000,'SURCHARGE','SURCHARGE','bpbilling',NULL,NULL,'package bpbilling.TEST;\n\nimport bp.billing.facts.*\nimport java.util.*\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"TEST\"\nagenda-group \"SURCHARGE\"\nno-loop\nsalience 50000\n\nwhen\n$LEDGER : BPLedgerFact( $ledgerid:ledgerid )\n$TAXFEE : TaxFeeFact( $taxfeeid:taxfeeid, ledgerid == $ledgerid )\nTaxFeeFact(lobid matches \"L-1042a565:1369ed5f52f:-7ffc|L-1042a565:1369ed5f52f:-7fae\", taxfeeid == $taxfeeid, ledgerid == $ledgerid)\nthen\n$TAXFEE.setSurchargeacctid(\"IA57e27d97:135e1abe297:-7fe0\");\n$TAXFEE.setSurchargeaccttitle(\"ADMINISTERING OATH\");\n$TAXFEE.setSurcharge(10.00);\n\nactionList.setContext( drools );\nactionList.execute(\"calcSurcharge\", $TAXFEE );\nend','[[objid:\"RC532d4556:136a4659fb5:-7ff0\",opener:\"bp-rule-mgmt:bpbilling_condition_taxfeefact\",displaytext:\"TaxFeeFact(lobid matches BAKERY, RICE RETAILER)\",constraints:[[displaytext:\"lobid matches BAKERY, RICE RETAILER\",fieldvar:null,value:[[objid:\"L-1042a565:1369ed5f52f:-7ffc\",name:\"BAKERY\"],[objid:\"L-1042a565:1369ed5f52f:-7fae\",name:\"RICE RETAILER\"]],field:[valueHandler:\"lob\",datatype:\"lob\",operatorHandler:\"string\",caption:\"Line of Business\",name:\"lobid\"],usevar:false,operator:[caption:\"matches\",name:\"matches\"]]],factname:\"TaxFeeFact\",conditiontype:\"TaxFeeFact\"]]','[[objid:\"RA532d4556:136a4659fb5:-7fef\",opener:\"bp-rule-mgmt:bpbilling_action_surcharge\",displaytext:\"Calculate Surcharge using formula: 10.00 for account ADMINISTERING OATH\",acctid:\"IA57e27d97:135e1abe297:-7fe0\",accttitle:\"ADMINISTERING OATH\",expr:\"10.00\",actiontype:\"calcSurcharge\"]]','[version:\"1.0\"]');
...
insert  into `rule_package`(`ruleset`,`rulegroup`,`packagename`,`orderindex`,`type`,`content`,`lastmodified`) values ('bpassessment','','bp.assessment.facts',0,'facts','package bp.assessment.facts\r\n\r\ndeclare ApplicationFact\r\n	appid             : String \r\n	applicationtype   : String    \r\n	organization      : String    \r\n	officetype        : String    \r\n	barangayid        : String\r\nend \r\n\r\ndeclare LOBFact\r\n	appid            : String	\r\n	lobid            : String  	\r\n	name             : String \r\n	assessmenttype   : String  \r\n	classificationid : String \r\n	attributes       : java.util.List \r\nend\r\n\r\ndeclare InputVariableFact \r\n	appid   : String \r\n	lobid   : String \r\n	varid   : String\r\n	varname : String \r\n	vartype : String \r\n	value   : Object\r\n	systype : String\r\nend \r\n\r\ndeclare TaxFeeFact\r\n	appid : String \r\n	lobid : String \r\n	acctid  : String \r\n	assessedvalue : Double\r\n	amountdue     : Double \r\nend \r\n\r\ndeclare TaxFeeSummaryFact\r\n	appid   : String\r\n	name    : String\r\n	acctid  : String\r\n	value   : Double\r\nend \r\n\r\ndeclare HighestComputed\r\n	appid : String \r\n	acctid : String\r\nend \r\n\r\ndeclare NotHighestComputed\r\n	appid : String \r\n	acctid : String\r\nend \r\n\r\ndeclare LowestComputed\r\n	appid : String \r\n	acctid : String\r\nend \r\n\r\ndeclare NotLowestComputed\r\n	appid : String \r\n	acctid : String\r\nend \r\n\r\n\r\n\r\n',NULL),('bpassessment','','bpassessment.ASK_GROSS',0,'rules','package bpassessment.ASK_GROSS;\nimport bp.assessment.facts.*;\nimport java.util.*;\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"ASK_GROSS1\"\nagenda-group \"APPINFO\"\nno-loop\nsalience 50000\n\nwhen\n$app : ApplicationFact( $appid: appid )\n$lob : LOBFact( $lobid:lobid, $lobname:name, appid == $appid)	\nLOBFact( assessmenttype matches \"RENEW\", lobid == $lobid, appid == $appid )\n\nthen\nMap m = new HashMap();\nm.put(\"lobid\", $lobid );\nm.put(\"lobname\", $lobname );\nm.put(\"rulename\", \"ASK_GROSS\");\nm.put(\"varid\", \"V7bcf5fff:136857a553d:-7fee\" );\nm.put(\"requiredperlob\", true );\nm.put(\"required\", true );\nm.put(\"requiredbeforeprint\", false );\nactionList.setContext( drools );\nactionList.execute(\"addInfo\", m );\nend\n\n',NULL),('bpassessment','','bpassessment.GF',0,'rules','package bpassessment.GF;\nimport bp.assessment.facts.*;\nimport java.util.*;\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"GF1\"\nagenda-group \"RF\"\nno-loop\nsalience 50000\n\nwhen\n$app : ApplicationFact( $appid: appid )\n$lob : LOBFact( $lobid:lobid, $lobname:name, appid == $appid)	\nLOBFact( lobid not matches \"L22004bc9:13677342510:-7ff4\", lobid == $lobid, appid == $appid )\n\nthen\nMap m = new HashMap();\nm.put(\"rulename\", \"GF\");\nm.put(\"appid\", $appid);\nm.put(\"lobid\", $lobid);\nm.put(\"lobname\", $lobname);\nm.put(\"expr\", \"100\");\nm.put(\"acctid\", \"IA57e27d97:135e1abe297:-7fe6\");\nm.put(\"accttitle\", \"AFFIDAVITS (DEATH)\");\nm.put(\"applytype\", \"PERLINE\" );\nactionList.setContext( drools );\nactionList.execute(\"addTaxFee\", m );\nend\n\n',NULL),('bpassessment','','bpassessment.UPDATE_AMOUNT_RULE',0,'rules','package bpassessment.UPDATE_AMOUNT_RULE;\nimport bp.assessment.facts.*;\nimport java.util.*;\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"UPDATE_AMOUNT_RULE1\"\nagenda-group \"ABT\"\nno-loop\nsalience 50000\n\nwhen\n$app : ApplicationFact( $appid: appid )\n$lob : LOBFact( $lobid:lobid, $lobname:name, appid == $appid)	\nTAXFEEFACT: TaxFeeFact( AMOUNTDUE:assessedvalue, $acctid:acctid matches \"IA68fbd6ca:135e5876658:-7e80\", appid == $appid, lobid == $lobid )\n\nthen\nMap m = new HashMap();\nm.put(\"rulename\", \"UPDATE_AMOUNT_RULE\");\nm.put(\"taxfeefact\", TAXFEEFACT );\nm.put(\"expr\", \"AMOUNTDUE * 0.50\");\nm.put(\"varname\", \"AMOUNTDUE\");\nm.put(\"varvalue\", AMOUNTDUE);\nactionList.setContext( drools );\nactionList.execute(\"updateAnyTaxFee\", m );\nend\n\n',NULL),('bpbilling','','bp.billing.facts',0,'facts','package bp.billing.facts\r\n\r\ndeclare CurrentYearFact\r\n	year  : Integer\r\n	qtr   : Integer\r\n	month : Integer\r\n	day   : Integer\r\nend\r\n\r\ndeclare BPLedgerFact\r\n	ledgerid      : String\r\n	yearstarted   : Integer\r\n	lastyearpaid  : Integer\r\n	lastqtrpaid   : Integer\r\nend\r\n\r\ndeclare TaxFeeFact\r\n	ledgerid  : String\r\n	appid     : String \r\n	taxfeeid  : String \r\n	lobid     : String\r\n	lobname   : String\r\n	rulename  : String\r\n	year      : Integer\r\n	qtr       : Integer\r\n	monthsfromjan : Integer\r\n	monthsfromqtr : Integer\r\n	daysfromjan : Integer\r\n	daysfromqtr : Integer\r\n	acctid    : String\r\n	accttitle : String\r\n	amount    : Double\r\n	surchargeacctid : String \r\n	surchargeaccttitle : String \r\n	surcharge   : Double \r\n	interestacctid : String	\r\n	interestaccttitle : String \r\n	interest  : Double\r\n	discount  : Double\r\n	expr      : String \r\n	varlist   : java.util.Map\r\n	applysurcharge	: Boolean\r\n	applydiscount	: Boolean\r\nend\r\n\r\n\r\n\r\n',NULL),('bpbilling','','bpbilling.DISCOUNT_TEST',0,'rules','package bpbilling.DISCOUNT_TEST;\n\nimport bp.billing.facts.*\nimport java.util.*\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"DISCOUNT_TEST\"\nagenda-group \"DISCOUNT\"\nno-loop\nsalience 50000\n\nwhen\n$LEDGER : BPLedgerFact( $ledgerid:ledgerid )\n$TAXFEE : TaxFeeFact( $taxfeeid:taxfeeid, ledgerid == $ledgerid )\nTaxFeeFact(AMTDUE:amount, taxfeeid == $taxfeeid, ledgerid == $ledgerid)\nthen\n$TAXFEE.setDiscount(AMTDUE * 0.25);\nactionList.setContext( drools );\nactionList.execute(\"calcDiscount\", $TAXFEE );\nend',NULL),('bpbilling','','bpbilling.INTEREST',0,'rules','package bpbilling.INTEREST;\n\nimport bp.billing.facts.*\nimport java.util.*\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"INTEREST\"\nagenda-group \"INTEREST\"\nno-loop\nsalience 50000\n\nwhen\n$LEDGER : BPLedgerFact( $ledgerid:ledgerid )\n$TAXFEE : TaxFeeFact( $taxfeeid:taxfeeid, ledgerid == $ledgerid )\nTaxFeeFact(applysurcharge == true, AMTDUE:amount, taxfeeid == $taxfeeid, ledgerid == $ledgerid)\nthen\n$TAXFEE.setInterestacctid(\"IA41a0f494:13564c96212:-7f28\");\n$TAXFEE.setInterestaccttitle(\"BASIC CURRENT PENALTY\");\n$TAXFEE.setInterest(AMTDUE * 0.25);\n\nactionList.setContext( drools );\nactionList.execute(\"calcInterest\", $TAXFEE );\nend',NULL),('bpbilling','','bpbilling.TEST',0,'rules','package bpbilling.TEST;\n\nimport bp.billing.facts.*\nimport java.util.*\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"TEST\"\nagenda-group \"SURCHARGE\"\nno-loop\nsalience 50000\n\nwhen\n$LEDGER : BPLedgerFact( $ledgerid:ledgerid )\n$TAXFEE : TaxFeeFact( $taxfeeid:taxfeeid, ledgerid == $ledgerid )\nTaxFeeFact(lobid matches \"L-1042a565:1369ed5f52f:-7ffc|L-1042a565:1369ed5f52f:-7fae\", taxfeeid == $taxfeeid, ledgerid == $ledgerid)\nthen\n$TAXFEE.setSurchargeacctid(\"IA57e27d97:135e1abe297:-7fe0\");\n$TAXFEE.setSurchargeaccttitle(\"ADMINISTERING OATH\");\n$TAXFEE.setSurcharge(10.00);\n\nactionList.setContext( drools );\nactionList.execute(\"calcSurcharge\", $TAXFEE );\nend',NULL),('ctcassessment','','ctc.assessment.facts',0,'facts','package ctc.assessment.facts\r\n\r\ndeclare IndividualFact\r\n	profession:	String\r\n	citizenship:	String\r\n	gender:		String\r\n	civilstatus:	String\r\n	seniorcitizen:  Boolean\r\n	annualsalary:	Double\r\n	businessgross:	Double\r\n	propertyincome: Double\r\nend\r\n\r\ndeclare CorporateFact\r\n	orgtype:	String\r\n	realpropertyav:	Double\r\n	businessgross:	Double\r\nend\r\n\r\ndeclare BarangayFact\r\n	barangayid:	String\r\nend',NULL),('rptbilling','','etracs2.rpt.billing.facts',0,'facts','package etracs2.rpt.billing.facts;\r\n\r\ndeclare CurrentYearFact\r\n        factname  : String\r\n	year  : Integer\r\n	qtr   : Integer\r\n	month : Integer\r\n	day   : Integer\r\nend\r\n\r\ndeclare RPTLedgerFact\r\n    rptledgerid             : String\r\n    factname                : String\r\n    firstitem               : Boolean\r\n    ledgerid                : String\r\n    rulename                : String\r\n    tdno                    : String \r\n    year                    : Integer\r\n    qtr                     : Integer \r\n    assessedvalue           : Double\r\n    txntype                 : String \r\n    rputype                 : String \r\n    classid                 : String\r\n    actualuseid             : String\r\n    numberofmonthsfromqtr   : Integer\r\n    numberofmonthsfromjan   : Integer\r\n    firstqtrpaidontime      : Boolean\r\n    qtrlypaymentavailed     : Boolean\r\n    backtax                 : Boolean \r\n    fullpayment             : Boolean \r\n    advancepayment          : Boolean \r\n    lastyearpaid            : Integer\r\n    lastqtrpaid             : Integer \r\n\r\n    revtype                 : String\r\n    basic                   : Double\r\n    basicint 	            : Double\r\n    basicdisc   	    : Double\r\n    sef                     : Double\r\n    sefint                  : Double\r\n    sefdisc                 : Double\r\n    \r\n    basicacctid             : String \r\n    basicintacctid          : String \r\n    sefacctid               : String \r\n    sefintacctid            : String \r\n\r\n    partialbasic            : Double\r\n    partialsef              : Double	\r\n\r\n    varlist                 : java.util.Map\r\n    expr                    : String \r\nend     \r\n\r\n',NULL),('rptbilling','','rptbilling.BASIC',0,'rules','package rptbilling.BASIC;\n\nimport etracs2.rpt.billing.facts.*\nimport java.util.*\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"BASIC\"\nagenda-group \"TAX\"\nno-loop\nsalience 50000\n\nwhen\n$LEDGER : RPTLedgerFact( $ledgerid:ledgerid )\nCurrentYearFact(CY:year)\nRPTLedgerFact(AV:assessedvalue, ledgerid == $ledgerid)\nthen\n$LEDGER.setBasicacctid(\"IA41a0f494:13564c96212:-7f22\");\n$LEDGER.setExpr(\"AV * 0.01\");\n$LEDGER.setRevtype(\"current\");\n$LEDGER.setVarlist( new HashMap() );\nactionList.setContext( drools );\nactionList.execute(\"calcBasic\", $LEDGER);\nend',NULL),('rptbilling','','rptbilling.SEF',0,'rules','package rptbilling.SEF;\n\nimport etracs2.rpt.billing.facts.*\nimport java.util.*\n\nglobal com.rameses.rules.common.RuleAction actionList\n\nrule \"SEF\"\nagenda-group \"TAX\"\nno-loop\nsalience 50000\n\nwhen\n$LEDGER : RPTLedgerFact( $ledgerid:ledgerid )\nCurrentYearFact(CY:year)\nRPTLedgerFact(AV:assessedvalue, classid matches \"COM|RES\", ledgerid == $ledgerid)\nthen\n$LEDGER.setSefacctid(\"IA41a0f494:13564c96212:-7f36\");\n$LEDGER.setExpr(\"AV * 0.01\");\n$LEDGER.setRevtype(\"current\");\n$LEDGER.setVarlist( new HashMap() );\nactionList.setContext( drools );\nactionList.execute(\"calcSef\", $LEDGER);\nend',NULL);
...
insert  into `rulegroup`(`objid`,`name`,`sortorder`,`ruleset`) values ('ABT','AFTER BUSINESS TAX',2,'bpassessment'),('AOC','AFTER OTHER CHARGE',6,'bpassessment'),('APPINFO','APPLICATION INFO',0,'bpassessment'),('ARF','AFTER REGULATORY FEE',4,'bpassessment'),('BT','BUSINESS TAX',1,'bpassessment'),('DISCOUNT','DISCOUNT',2,'bpbilling'),('DISCOUNT','DISCOUNT',2,'rptbilling'),('INTEREST','INTEREST',1,'bpbilling'),('OC','OTHER CHARGE',5,'bpassessment'),('PENALTY','PENALTY',1,'rptbilling'),('RF','REGULATORY FEE',3,'bpassessment'),('SUM','SUMMARY',7,'bpassessment'),('SUMMARY','SUMMARY',3,'bpbilling'),('SUMMARY','SUMMARY',3,'rptbilling'),('SURCHARGE','SURCHARGE',0,'bpbilling'),('TAX','TAX',0,'rptbilling');
...
insert  into `sys_roleclass_module`(`roleclass`,`module`) values ('BP','bp2'),('TREASURY','bp2'),('TREASURY','ctc2'),('ADMIN','etracs2-admin'),('BP','etracs2-entity'),('IT','etracs2-entity'),('RPT','etracs2-entity'),('TREASURY','etracs2-entity'),('ADMIN','jobposition'),('ADMIN','orgunit'),('ADMIN','personnel'),('ADMIN','role'),('RPT','rpt2'),('TREASURY','rpt2'),('ACCOUNTING','tc2'),('TREASURY','tc2');
...
insert  into `sys_sequence`(`objid`,`nextSeries`) values ('BP2012',2),('ENTITY',3);
